    ...
    def get_part_by_part_number(self, part_number):
        ...
        try:
            with connection.cursor() as cursor:
                sql = """SELECT part.partNumber, part.description, part.partTypeSubClass1, part.partTypeSubClass2, part.partTypeSubClass3, part.partTypeSubClass1, part.dateAdded, part.unit, part.status, partStatus.statusName
                FROM part
                INNER JOIN partStatus ON part.status = partStatus.id
                WHERE partNumber = %s"""
